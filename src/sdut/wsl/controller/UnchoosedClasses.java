...
/**
 * Servlet implementation class UnchoosedClasses
 */
@WebServlet("/UnchoosedClasses")
public class UnchoosedClasses extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UnchoosedClasses() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List ret=null;
		try {
			ret=new StudentDao().getUnchoosedClasses(s.getSno());
